...
/*  It sets an item in the browser's local storage with the key "lang" and the value "eng", 
    which means that the user's preferred language is set to English. After running this 
    function once, the function is set to undefined to prevent it from being run again. 
*/

Once();
/* This line calls the Once function, which sets the user's preferred language to English 
   and then disables itself from being run again.*/

localStorage.setItem("lang", "eng");
/* This line sets an item in the browser's local storage with the key "lang" and the value "eng", 
   which means that the user's preferred language is set to English. 
   This line may be redundant if the Once function has already been called.
*/
let slideIndex = 1;
